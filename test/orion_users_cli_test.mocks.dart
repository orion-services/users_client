...
class MockUsersWebService extends _i1.Mock implements _i3.UsersWebService {
  ...
  @override
  bool get https => (super.noSuchMethod(
        Invocation.getter(#https),
        returnValue: false,
      ) as bool);
  @override
  set https(bool? _https) => super.noSuchMethod(
        Invocation.setter(
          #https,
          _https,
        ),
  ...
  @override
  String get port => (super.noSuchMethod(
        Invocation.getter(#port),
        returnValue: '',
      ) as String);
  @override
  set port(String? _port) => super.noSuchMethod(
        Invocation.setter(
          #port,
          _port,
        ),
  ...
  @override
  String get wsEndpoint => (super.noSuchMethod(
        Invocation.getter(#wsEndpoint),
        returnValue: '',
      ) as String);
  @override
  set wsEndpoint(String? _wsEndpoint) => super.noSuchMethod(
        Invocation.setter(
          #wsEndpoint,
          _wsEndpoint,
        ),
  ...
  @override
  String get api => (super.noSuchMethod(
        Invocation.getter(#api),
        returnValue: '',
      ) as String);
  @override
  set api(String? _api) => super.noSuchMethod(
        Invocation.setter(
          #api,
          _api,
        ),
  ...
  @override
  String get wsURL => (super.noSuchMethod(
        Invocation.getter(#wsURL),
        returnValue: '',
      ) as String);
  @override
  set wsURL(String? _wsURL) => super.noSuchMethod(
        Invocation.setter(
          #wsURL,
          _wsURL,
        ),
